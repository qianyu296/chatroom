...
public class UserController {
     ...
     * */
    @PostMapping("/login")
    public Result Login(@Validated @RequestBody Users user){
    ...
    public Result Register(@Validated @RequestBody Users user){
    ...
    public Result getCurrentUser(){
        ...
        return Result.Success("200","获取成功",currentUser);
    }
    /**
     * 更新用户信息
     * @param user
    ...
    public Result updateUser(@RequestBody Users user){
        ...
        return Result.Success("200","更新成功", res);
    }
    /**
     * 搜索用户（可添加好友）
     * @param username
    ...
    public Result searchUser(@PathVariable String username){
        ...
        if(userInfo == null){
            return Result.Error("400","未搜索到该用户!");
        }
        return Result.Success("200","success",userInfo);
    }
